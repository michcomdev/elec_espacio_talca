    ...
    try {
        ...
        internals.members.table = $('#tableMembers')
            .DataTable({
                ...
                responsive: true,
                columnDefs: [
                            { targets: [0, 1, 2, 3, 4, 5, 12, 13, 14, 15, 16], className: 'dt-center' },
...
async function getAllInvoices(){
    ...
    if (allInvoices.data.length > 0) {
        ...
        let formatData = allInvoices.data.map(el => {
            ...
            el.total = dot_separators(el.invoiceSubTotal + agreementsTotal)
